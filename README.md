...
![Create Collection](POSTMAN/img/taocol.png)
...
![Create Environment](POSTMAN/img/taoEnviroment.png)
...
![Add Variable](POSTMAN/img/taoEnviroment.png)
...
![Attach Environment](POSTMAN/img/taoreqthemev.png)
...
![GET Test](POSTMAN/img/testGET.png)
...
![POST Test](POSTMAN/img/TestPOST.png)
...
![PUT Test](POSTMAN/img/testPUT.png)
...
![DELETE Test](POSTMAN/img/testDELETE.png)
...
pm.test("Status code valid", function () {
  pm.expect([200, 404].includes(pm.response.code)).to.be.true;
});
...
![GET Huge ID](POSTMAN/img/testGetIDlon.png)
...
![GET Negative ID](POSTMAN/img/testGETIDAM.png)
...
![Weather API](POSTMAN/img/testAPIthoitiet.png)
...
![Collection Runner](POSTMAN/img/RunFULLTEST.png)
